...
\textbf{PRAHARI: AI-Powered Malware Analysis Platform Using Ghidra | NFSU} \hfill Sep 2025 -- Present |
\href{https://github.com/MIHIR-RANJAN/PRAHARI-AI-POWERED-MALWARE-ANALYSIS-PLATFORM-USING-GHIDRA.git}{GitHub}
\resumeItemListStart
\item Built an AI-powered malware analysis platform combining Ghidra reverse engineering with multi-LLM agents to automatically analyze binaries, extract technical artifacts, and generate human-readable security insights, achieving 99.99\% success across 130+ samples.
\item Designed a full-stack system using FastAPI, React, and custom Ghidra scripts to analyze binaries up to 100MB in 2--5 minutes, with cost-optimized prompting reducing LLM token usage by ~50\% and structured JSON outputs for traceability.
\resumeItemListEnd
